...
def draw_boxes(img, bbox, names,object_id, identities=None, offset=(0, 0)):
    ...
    for i, box in enumerate(bbox):
        ...
        for idx, (key, value) in enumerate(object_counter1.items()):
            ...
            # This display the total count of vehicles
            ###
            cv2.putText(img, "Total Count: "+str(count_up), (width - 500, 35), 0, 1, [255, 0, 0], thickness=2, lineType=cv2.LINE_AA)
        ...
        for idx, (key, value) in enumerate(object_counter.items()):
            ...
            ###
            cv2.putText(img, "Total Count: " +str(count_down), (11, 75), 0, 1, [255, 0, 0], thickness=2, lineType=cv2.LINE_AA)
